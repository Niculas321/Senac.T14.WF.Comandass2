namespace Comandas2
{
    partial class Principal
    {
        ...
        private void InitializeComponent()
        {
            ...
            // PedidoCozinha
            // 
            PedidoCozinha.Alpha = 20;
            PedidoCozinha.BackColor = Color.Transparent;
            PedidoCozinha.Background = true;
            PedidoCozinha.Background_WidthPen = 4F;
            PedidoCozinha.BackgroundPen = true;
            PedidoCozinha.ColorBackground = Color.FromArgb(255, 255, 128);
            PedidoCozinha.ColorBackground_1 = Color.Black;
            PedidoCozinha.ColorBackground_2 = Color.Black;
            PedidoCozinha.ColorBackground_Pen = Color.Black;
            PedidoCozinha.ColorLighting = Color.FromArgb(29, 200, 238);
            PedidoCozinha.ColorPen_1 = Color.FromArgb(37, 52, 68);
            PedidoCozinha.ColorPen_2 = Color.FromArgb(41, 63, 86);
            PedidoCozinha.CyberButtonStyle = ReaLTaiizor.Enum.Cyber.StateStyle.Custom;
            PedidoCozinha.Effect_1 = true;
            PedidoCozinha.Effect_1_ColorBackground = Color.FromArgb(29, 200, 238);
            PedidoCozinha.Effect_1_Transparency = 25;
            PedidoCozinha.Effect_2 = true;
            PedidoCozinha.Effect_2_ColorBackground = Color.White;
            PedidoCozinha.Effect_2_Transparency = 20;
            PedidoCozinha.Font = new Font("Arial Black", 11F, FontStyle.Bold, GraphicsUnit.Point, 0);
            PedidoCozinha.ForeColor = Color.Black;
            ...
            PedidoCozinha.RoundingInt = 70;
            PedidoCozinha.Size = new Size(146, 115);
            PedidoCozinha.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.HighQuality;
            PedidoCozinha.TabIndex = 2;
            PedidoCozinha.Tag = "Cyber";
            PedidoCozinha.TextButton = "Pedido Cozinha";
            ...
            Comanda.Background_WidthPen = 4F;
            Comanda.BackgroundPen = true;
            Comanda.ColorBackground = Color.FromArgb(192, 255, 255);
            Comanda.ColorBackground_1 = Color.Black;
            Comanda.ColorBackground_2 = Color.Black;
            Comanda.ColorBackground_Pen = Color.Black;
            Comanda.ColorLighting = Color.Transparent;
            Comanda.ColorPen_1 = Color.FromArgb(37, 52, 68);
            Comanda.ColorPen_2 = Color.FromArgb(41, 63, 86);
            Comanda.CyberButtonStyle = ReaLTaiizor.Enum.Cyber.StateStyle.Custom;
            Comanda.Effect_1 = true;
            Comanda.Effect_1_ColorBackground = Color.FromArgb(29, 200, 238);
            Comanda.Effect_1_Transparency = 25;
            Comanda.Effect_2 = true;
            Comanda.Effect_2_ColorBackground = Color.White;
            Comanda.Effect_2_Transparency = 20;
            Comanda.Font = new Font("Arial Black", 11F, FontStyle.Bold, GraphicsUnit.Point, 0);
            Comanda.ForeColor = Color.Black;
            ...
            Comanda.RoundingInt = 70;
            Comanda.Size = new Size(146, 115);
            Comanda.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.HighQuality;
            Comanda.TabIndex = 1;
            Comanda.Tag = "Cyber";
            Comanda.TextButton = "Comanda";
            ...
            // 
            Cardapio.Alpha = 20;
            Cardapio.BackColor = Color.Transparent;
            Cardapio.Background = true;
            Cardapio.Background_WidthPen = 4F;
            Cardapio.BackgroundPen = true;
            Cardapio.ColorBackground = Color.FromArgb(192, 255, 192);
            Cardapio.ColorBackground_1 = Color.Black;
            Cardapio.ColorBackground_2 = Color.Black;
            Cardapio.ColorBackground_Pen = Color.Black;
            Cardapio.ColorLighting = Color.Transparent;
            Cardapio.ColorPen_1 = Color.Black;
            Cardapio.ColorPen_2 = Color.Black;
            Cardapio.CyberButtonStyle = ReaLTaiizor.Enum.Cyber.StateStyle.Custom;
            Cardapio.Effect_1 = true;
            Cardapio.Effect_1_ColorBackground = Color.Transparent;
            Cardapio.Effect_1_Transparency = 25;
            Cardapio.Effect_2 = true;
            Cardapio.Effect_2_ColorBackground = Color.Transparent;
            Cardapio.Effect_2_Transparency = 20;
            Cardapio.Font = new Font("Arial Black", 11F, FontStyle.Bold, GraphicsUnit.Point, 0);
            Cardapio.ForeColor = Color.Black;
            ...
            Cardapio.RoundingInt = 70;
            Cardapio.Size = new Size(146, 115);
            Cardapio.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.HighQuality;
            Cardapio.TabIndex = 0;
            Cardapio.Tag = "Cyber";
            Cardapio.TextButton = "Cardápio";
